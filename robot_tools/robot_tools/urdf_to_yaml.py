...
# YAMLへの書き込み
with open("param_"+robot_name+"_name_lists.yaml", "w") as yaml_f:
  # 先頭のcommentの書き込み
  yaml_f.write("# Source URDF file path : " + urdf_path + 
"""# Generated by robot_tools/robot_tools/urdf_to_yaml.py
...
with open("param_"+robot_name+"_joints.yaml", "w") as yaml_f:
  # 先頭のcommentの書き込み
  yaml_f.write("# Source URDF file path : " + urdf_path + 
"""# Generated by robot_tools/robot_tools/urdf_to_yaml.py
...
with open("param_"+robot_name+"_limb.yaml", "w") as yaml_f:
  # 先頭のcommentの書き込み
  yaml_f.write("# Source URDF file path : " + urdf_path + 
"""# Generated by robot_tools/robot_tools/urdf_to_yaml.py
